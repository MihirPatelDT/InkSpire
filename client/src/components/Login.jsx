...
const Login = () => {
  ...
  // Below is for disable and enable scrolling
  useEffect(() => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center">
      ...
      >
        ...
        {state === "Login" ? (
          <p className="text-sm mt-3">Welcome back! Please login to continue</p>
        ) : (
        ...
        {state !== "Login" && (
          <div className="border px-6 py-2 flex items-center gap-2 rounded-full mt-5">
            <img src={assets.profile_icon} alt="User Icon" width={20} />
            <input
